...
const page: ServicePage = {
  ...
  sections: [
    ...
    { eyebrow: "DISEÑO WEB A TU MEDIDA", title: "¿Qué problemas resuelve\nun sitio web profesional para tu empresa?", lead: "Conocé cómo un sitio web profesional ayuda a resolver los desafíos de tu negocio. Más visibilidad, más confianza y más oportunidades de crecer.", visual: "wilde", actions: true, hideItemNumbers: true, items: [
